...
class CustomerFormState extends State<CustomerForm> {
  ...
  Widget build(BuildContext context) {
    postUser() async {
      final response =
          await http.post(Uri.parse('http://10.0.2.2:5000/api/userdata'),
          ...
          child: Column(children: [
            ...
            Row(
              children: [
                ...
                DropdownButton<String>(
                  hint: Text(_branch, style: TextStyle(fontSize: 15.0)),
                  underline: Container(
                    height: 2,
                    color: Colors.teal,
                  ),
                  ...
                  items:
                      branchList.map<DropdownMenuItem<String>>((String value) {
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  'ඔබේ විමසීම මෙතැනින් අප වෙත යොමුකරන්න',
